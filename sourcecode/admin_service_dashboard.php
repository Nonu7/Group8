...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <label>ISBN:</label><input  type="text" name="bookdetail"/></br>
            <label>Author:</label><input type="text" name="bookaudor"/></br>
            <label>Publication</label><input type="text" name="bookpub"/></br>
            <div><label>Category:</label><input type="radio" name="branch" value="SCIENCE"/>SCIENCE<input type="radio" name="branch" value="FICTION"/>FICTION<div style="margin-left:80px"><input type="radio" name="branch" value="NON-FICTION"/>NON-FICTION<input type="radio" name="branch" value="OTHER"/>OTHER</div>
            </div>   
            <label>Edition:</label><input  type="text" name="bookprice"/></br>
            ...
            <label>Password:</label><input type="pasword" name="addpass"/></br>
            ...
            $table="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'><tr><th style='  
            padding: 8px;'>User Name</th><th>Book Name</th><th>Issue Date</th><th>Return Date</th><th>Fine</th></th><th>User Type</th></tr>";
...
?>
            ...
            <p style="color:black"><u>Book ISBN:</u> &nbsp&nbsp<?php echo $bookdetail ?></p>
            ...
            <p style="color:black"><u>Book Edition:</u> &nbsp&nbsp<?php echo $bookprice ?></p>
            ...
            $table="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'><tr><th style=' 
            padding: 8px;'>Book Name</th><th>Edition</th><th>Qnt</th><th>Available</th><th>Rent</th></th><th>View</th></tr>";
            foreach($recordset as $row){
                $table.="<tr>";
               "<td>$row[0]</td>";
                $table.="<td>$row[2]</td>";
