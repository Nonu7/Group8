    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div class="leftinnerdiv">
                ...
                <br>
                <Button class="greenbtn" onclick="openpart('addbook')" ><img class="icons" src="images/icon/book2.png" width="30px" height="30px"/>  ADD BOOK</Button>
    ...
    <div id="addbook" class="innerright portion" style="<?php if (!empty($_REQUEST['viewid'])) { echo "display:none"; } else { echo ""; } ?>">
        ...
        <form action="addbookserver_page.php" method="post" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" name="bookaudor" />
            </div>
            <div>
            ...
            <div>
                ...
                <input type="radio" name="branch" value="SCIENCE" />SCIENCE
                <input type="radio" name="branch" value="FICTION" />FICTION
                <div style="margin-left: 283px">
                    <input type="radio" name="branch" value="NON-FICTION" />NON-FICTION
...
?>
            ...
            <p style="color:black"><u>Book Author(s):</u> &nbsp&nbsp<?php echo $bookauthour ?></p>
